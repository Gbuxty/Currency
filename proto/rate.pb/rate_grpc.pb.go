...
type RateServiceClient interface {
	GetRates(ctx context.Context, in *GetRatesRequest, opts ...grpc.CallOption) (*RateResponse, error)
}
...
func (c *rateServiceClient) GetRates(ctx context.Context, in *GetRatesRequest, opts ...grpc.CallOption) (*RateResponse, error) {
...
type RateServiceServer interface {
	GetRates(context.Context, *GetRatesRequest) (*RateResponse, error)
...
func (UnimplementedRateServiceServer) GetRates(context.Context, *GetRatesRequest) (*RateResponse, error) {
